...
import {ECalendarValue, IDatePickerConfig} from '../../../../projects/ngx-jalali-date-picker/src/public-api';
...
export class ConfigFormComponent implements OnInit {
  ...
  @Output() onDisplayDateChange = new EventEmitter<Moment>();
  ...
  ngOnInit() {
    ...
    this.format = new UntypedFormControl(this.getDefaultFormatByMode(this.pickerMode));
    this.locale = new UntypedFormControl(this.config.locale);
